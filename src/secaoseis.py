...
print(fPara sacar R${saque}, será necessário as seguintes notas:
...
print(f'A soma de todos os números primos entre {inicio} e {fim} é {sum(lista)}')
